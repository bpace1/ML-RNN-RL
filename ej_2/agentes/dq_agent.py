...
class QAgent(Agent):
    ...
    """
    def __init__(self, actions, game=None, learning_rate=0.5, discount_factor=0.99,
                 epsilon=0.1, epsilon_decay=0.995, min_epsilon=0.01, load_q_table_path="flappy_birds_q_table.pkl"):
    ...
    def discretize_state(self, state):
        ...
        # ---- Discretización de Distancia al Tubo ----
        # Se toma la distancia al tubo y se discretiza en 3 niveles:
        # 0 : Muy cerca, 1: Cerca, 2: Lejos
        # distance_to_pipe = state['next_pipe_dist_to_player']
        # if distance_to_pipe < 90:  # Muy cerca
        #     distance_to_pipe_bin = 0
        # elif distance_to_pipe < 180:  # Cerca
        #     distance_to_pipe_bin = 1
        # else:  # Lejos
        #     distance_to_pipe_bin = 2
